...
import TruckloadBackground from "./TruckloadBackground";
        ...
        <div className="w-1/2">
          <div className="w-3/4" style={{ marginLeft: "10%" }}>
            ...
            <h2 className="text-1.5vw uppercase font-bold">
              full truckload, full service
            </h2>
            <p className="text-1.25vw uppercase">
              consider your full truckload needs met. we deliver a full
              truckload with full service.
            </p>
