...
import IntermodelBackground from "./InternmodelBackground";
import { Link } from "react-router-dom";
import { motion } from "framer-motion";

const drayage = () => {
  return (
    <motion.div className="h-screen overflow-hidden" initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:0}}>
      <NavBar color="black" hamcolor="black"/>
      <div className="w-full flex items-center" style={{ marginTop: "20vh" }}>
        <div className="w-1/2">
          <IntermodelBackground />
        </div>
        <div className="w-1/2">
          <div className="w-3/4" style={{ marginLeft: "10%" }}>
            ...
            <p className="text-1.25vw uppercase">
              move your freight to and from rails yards to your dedicated locations
            </p>
