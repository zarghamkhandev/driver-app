...
import LtlBackground from "./LtlBackground";
        ...
        <div className="w-1/2">
          <div className="w-3/4" style={{ marginLeft: "10%" }}>
            ...
            <h2 className="text-1.5vw uppercase font-bold">
              ltl (less than truckload), more than exceptional
            </h2>
            <p className="text-1.25vw uppercase">
              partial shipments are welcome. manage your local deliveries with ease.
            </p>
