...
import ExpeditedBackground from "./ExpeditedBackground";
      ...
      <div className="w-full flex items-center" style={{ marginTop: "15vh" }}>
        ...
        <div className="w-1/2">
          <div className="w-3/4" style={{ marginLeft: "10%" }}>
            ...
            EXPEDITED/HOTSHOT in a flash
            </h2>
            <p className="text-1.25vw uppercase">
            who isn't in a hurry nowadays? if you have a time-sensitive delivery, we'll get it there on time every time.
            </p>
